...
def stereo_calibrate(mtx1, dist1, mtx2, dist2, left_images, right_images, calibration_parameters):
    ...
    print("The overall reprojection error (RMS)", ret)
...
if __name__ == "__main__":
    ...
    ret, K1, D1, K2, D2, R, T, E, F = stereo_calibrate(mtx1, dist1, mtx2, dist2, config.CALIBRATION_IMAGES_LEFT_PATH + '*', config.CALIBRATION_IMAGES_RIGHT_PATH + '*', calibration_parameters)
    ...
    np.savez(
        config.CALIBRATION_PATH + config.CALIBRATION_VAR_FILE,
        K1=K1,
        D1=D1,
        K2=K2,
        D2=D2,
